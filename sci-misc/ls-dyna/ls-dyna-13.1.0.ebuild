...
FN_S="${PN}_smp_s_R$(ver_cut 1)_$(ver_cut 2)_$(ver_cut 3)_centos79_intel190"
FN_D="${PN}_smp_d_R$(ver_cut 1)_$(ver_cut 2)_$(ver_cut 3)_centos79_intel190"
...
SRC_URI="single-precision? ( http://ftp.lstc.com/user/${PN}/R${PV}/linx.64/${FN_S}.${SH} )
	...
	source? ( single-precision? ( http://ftp.lstc.com/objects/${PN}/R${PV}/${FN_S}.usermat.${SH} )
		double-precision? ( http://ftp.lstc.com/objects/${PN}/R${PV}/${FN_D}.usermat.${SH} ) )"
...
src_install() {
	...
	exeinto /opt/${PN}/${PV}
	use single-precision && doexe "${PN}_smp_s_R$(ver_cut 1)_$(ver_cut 2)_$(ver_cut 3)_x64_centos79_ifort190"
	use double-precision && doexe "${PN}_smp_d_R$(ver_cut 1)_$(ver_cut 2)_$(ver_cut 3)_x64_centos79_ifort190"
