...
RDEPEND="
	...
	>=sci-libs/intel-oneapi-compiler-dpcpp-cpp-classic-fortran-shared-runtime-${MY_PV}
	>=sci-libs/intel-oneapi-compiler-shared-runtime-${MY_PV}
	>=sci-libs/intel-oneapi-mpi-${MY_PV}
"
