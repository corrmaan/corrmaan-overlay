...
inherit cuda flag-o-matic java-pkg-opt-2 toolchain-funcs multilib multilib-minimal
...
SLOT="0"
KEYWORDS="~amd64"
IUSE="cma cuda cxx fortran icc ipv6 java libompitrace peruse romio
...
CDEPEND="
	...
	icc? ( sci-libs/intel-hpckit[cxx,fortran?] )
